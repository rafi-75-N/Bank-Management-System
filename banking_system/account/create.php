...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO account (Balance, AccountType, MaximumLimit, YearlyFee, MinimumBalance, InterestRate, CustID) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    $stmt->bind_param('dsddddi', $Balance, $AccountType, $MaximumLimit, $YearlyFee, $MinimumBalance, $InterestRate, $CustID);
    if ($stmt->execute()) {
...
<h3 class="mb-3 text-capitalize">Create account</h3>
...
<form method="post" class="card p-3 shadow-sm">
  <div class="row g-3">
    ...
    <div class="col-md-6">
      ...
      <input type="number" name="MaximumLimit" class="form-control" step="0.01" required>
    </div>

    <div class="col-md-6">
      <label class="form-label">YearlyFee</label>
      <input type="number" name="YearlyFee" class="form-control" step="0.01" required>
    </div>

    <div class="col-md-6">
      <label class="form-label">MinimumBalance</label>
      <input type="number" name="MinimumBalance" class="form-control" step="0.01" required>
    </div>

    <div class="col-md-6">
      <label class="form-label">InterestRate</label>
      <input type="number" name="InterestRate" class="form-control" step="0.01" required>
    </div>
